...
var _IStorageProvider = _interopRequireDefault(require("../../../shared/container/provider/StorageProvider/models/IStorageProvider"));
...
let UpdateUserAvatarService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    if (!user) {
      throw new _AppError.default('Only auhenticated users can change avatar.', 401);
    }
