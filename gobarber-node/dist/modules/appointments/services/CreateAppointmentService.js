...
let CreateAppointmentService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    if ((0, _dateFns.isBefore)(appointmentDate, Date.now())) {
      throw new _AppError.default('You can not create a appointment in a past date.');
    }

    if (user_id === provider_id) {
      throw new _AppError.default('You can not create a appointment whit yourself.');
    }

    if ((0, _dateFns.getHours)(appointmentDate) < 8 || (0, _dateFns.getHours)(appointmentDate) > 17) {
      throw new _AppError.default('You can not create a appointment before 8am and after 5pm.');
    }
